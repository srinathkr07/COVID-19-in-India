...
Stats and Visualization {data-icon="fa-line-chart"}
=====
...
Since the data is scraped from [Ministry of Health and Family Welfare, Government of India](https://www.mohfw.gov.in/) and **the format of the page is changed often**, one might not be able to see the stats and visualisation, if the page format doesn't match with the one I have coded for. I'll look for changes daily, if any and try to fix them. 

For any other question or feedback, you can either open an [issue](https://github.com/srinathkr07/COVID-19-in-India/issues) or contact me on [LinkedIn](https://www.linkedin.com/in/srinath-kr-026147173/).
