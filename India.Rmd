...
div(actionButton(inputId = "GitHubRepo", icon = icon("github"), label = "Open Sourced on GitHub", onclick  = "window.open('https://github.com/srinathkr07/COVID-19-in-India/', '_blank')"), align = "center")
