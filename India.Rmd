...
daily = data.frame(matrix(ncol = 8, nrow = 0))
colnames(daily) = c("Date", "DailyConfirmed", "DailyRecovered", "DailyDeath", "TotalConfirmed", "TotalActive", "TotalRecovered", "TotalDeath")
